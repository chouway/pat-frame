 ...
 **/
public class PatRedisAuthCodeService extends RandomValueAuthorizationCodeServices {
    ...
    public PatRedisAuthCodeService(RedisConnectionFactory connectionFactory) {
