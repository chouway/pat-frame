...
public class PatMobileCodeAuthProvider implements AuthenticationProvider, MessageSourceAware {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        String cacheCode = stringRedisTemplate.opsForValue().get(PatOauthConstant.CACHE_SMS_CODE + mobile);
        ...
        //清除redis中的短信验证码
        //stringRedisTemplate.delete(PatOauthConstant.CACHE_SMS_CODE + mobile);
        UserDetails user;
        try {
